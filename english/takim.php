              ...
              <div class="member-info">
                <div class="member-info-content">
                  ...
                  <div class="social">
                    ...
                    <a href="kisiler_en/huseyin_en.php">View More
                        
                        <i class="fa fa-arrow-right button__icon"></i>
                        </a>
                    </span>
                  </div>
                </div>
          ...
          <div class="col-lg-3 col-md-6 wow fadeInUp">
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Selim Aydın</h4>
                  <span>Founding Team Leader</span>
                  <div class="social">
                    ...
                    <span class="button button--flex button--small button--link services__button">
                    <a href="kisiler_en/selim_en.php">View More
              ...
              <div class="member-info">
                <div class="member-info-content">
                  ...
                  <div class="social">
                    ...
                    <span class="button button--flex button--small button--link services__button">
                      <a href="kisiler_en/bahri_en.php">View More
              ...
              <div class="member-info">
                <div class="member-info-content">
                  ...
                  <div class="social">
                    ...
                    <span class="button button--flex button--small button--link services__button">
                    <a href="kisiler_en/haydar_en.php">View More
                      ...
                      <div class="member-info"> 
                        <div class="member-info-content"> 
                          ...
                          <div class="social"> 
                            ...
                            <span class="button button--flex button--small button--link services__button"> 
                              <a href="kisiler/harun.php">View More 
              ...
              <div class="member-info">
                <div class="member-info-content">
                  ...
                  <div class="social">
                    ...
                    <span class="button button--flex button--small button--link services__button">
                    <a href="kisiler_en/resul_en.php">View More
              ...
              <div class="member-info">
                <div class="member-info-content">
                  ...
                  <div class="social">
                    ...
                    <span class="button button--flex button--small button--link services__button">
                    <a href="kisiler_en/ufuk_en.php">View More
                    ...
                    <div class="member"> 
                      ...
                      <div class="member-info"> 
                        <div class="member-info-content"> 
                          ...
                          <span>3D Developer</span> 
                          <div class="social"> 
                            <a target="_blank" href="https://www.instagram.com/tatliarslan0/"><i class="fa fa-instagram"></i></a> 
                            <span class="button button--flex button--small button--link services__button"> 
                              <a href="kisiler/murat.php">View More 
                                <i class="fa fa-arrow-right button__icon"></i></a>  
                              </span> 
                            </div> 
                          </div> 
