              ...
              <form action="islem/islem.php" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input name="sira" type="number" class="form-control" id="exampleInputEmail1" value="" placeholder="Lütfen Sıra Numarasını Giriniz">
                  </div>
...
?>
                ...
                <div class="card-footer">
                  <button name="takimekle" type="submit" class="btn btn-primary">Gönder</button>
                </div>
              </form>
            </div>
          </section>
