      ...
      <div class="row">
              ...
              <form action="islem/islem.php" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                    ...
                    <input name="baslik" type="text" class="form-control" id="exampleInputEmail1" value="" placeholder="Lütfen İlan Başlık Giriniz">
                  </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Açıklama</label>
                    <input name="aciklama" type="text" class="form-control" id="exampleInputEmail1" value="" placeholder="Lütfen İlan Açıklama Giriniz">
                  </div>
...
?>
                ...
                <div class="card-footer">
                  <button name="urunkaydet" type="submit" class="btn btn-primary">Gönder</button>
                </div>
              </form>
            </div>
          </section>
