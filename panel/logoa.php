      ...
      <div class="row">
              ...
              <form action="islem/islem.php" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Aşağı Logo</label>
                    <input name="logoa" type="file" class="form-control" id="exampleInputEmail1" value="" placeholder="Lüten Resim Ekleyin">
                  </div>
...
?>
                ...
                <div class="card-footer">
                  <button name="logoa" type="sumbit" class="btn btn-primary">Gönder</button>
                </div>
              </form>
            </div>
          </section>
