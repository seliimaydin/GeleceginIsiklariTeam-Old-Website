...
<head><title>Hüseyin Rahmi Yıldırım | Portfolio</title></head>
    <!--==================== MAIN ====================-->
    <main class="main">
        <!--==================== HOME ====================-->
                    ...
                    <div class="home__img">
                        <svg class="home__blob" viewBox="0 0 200 187" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            ...
                            <g mask="url(#mask0)">
                                ...
                                <image class="home__blob-img" x='12' y='18' xlink:href="../img/huseyin.jpg" />
                            </g>
                        </svg>
                    </div>
                    <div class="home__data">
                        <h1 class="home__title">Hi, I'am Bahri</h1>
        ...
        <section class="about section" id="about">
            ...
            <div class="about__container container grid">
                <img src="../english/img/kod6.jpg" alt="" class="about__img">
                <div class="about__data">
                    ...
                    <div class="about__info">
                        ...
                        <div>
                            ...
                            <span class="about__info-name">I Got a Mission</span>
                        </div>
                    </div>
                ...
                <div class="qualification__sections">
                    ...
                    <div class="qualification__content " data-content id="education">
                        ...
                        <div class="qualification__data">
                            <div>
                                <h3 class="qualification__title">Design Studies</h3>
                        ...
                        <div class="qualification__data">
                            ...
                            <div>
                                <h3 class="qualification__title">Işıkkent Anatolian Imam Hatip Highscool </h3>
                        ...
                        <div class="qualification__data">
                            <div>
                                <h3 class="qualification__title">Software Studies</h3>
                        ...
                        <div class="qualification__data">
                            ...
                            <div>
                                <h3 class="qualification__title">Team Studies</h3>
                    ...
                    <div class="qualification__content qualification__active" data-content id="work">
                        ...
                        <div class="qualification__data">
                            <div>
                                <h3 class="qualification__title">We set up the Geleceğin Işıkları team.</h3>
                        ...
                        <div class="qualification__data">
                            ...
                            <div>
                                <h3 class="qualification__title">Tübitak 2204-A Regional Final</h3>
